...
class Dataset(LightningDataModule):
    def __init__(
        ...
        super().__init__()
        self.original_dataset = load_dataset(dataset_name_or_path)
        self.label_names = self.original_dataset["train"].features["label"].names
    ...
    def setup(self, stage: str = None) -> None:
        ...
        )  # workaround to enable using cached datasets
        ...
        new_splits = self.dataset["train"].train_test_split(
            val_split_size, new_train_split_size
        )
