...
if __name__ == '__main__':
	...
	arg_parser.add_argument('--auto-lr-find', default=False, action='store_true',
	...
	dataset = Dataset(args.dataset, args.model_name_or_path, args.batch_size, args.num_workers)	
